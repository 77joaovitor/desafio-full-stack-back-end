...
export class createSchedule1675538722628 implements MigrationInterface {
    name = 'createSchedule1675538722628'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "schedules_user_property" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(60) NOT NULL, "email" character varying(60) NOT NULL, "cellphone" character varying(11) NOT NULL, "useridId" uuid, CONSTRAINT "PK_91a17926e63d5330aea0acf0c85" PRIMARY KEY ("id"))`);
